...
@section('content')
    <div>
        <div class="grid gap-4 lg:grid-cols-3">
            ...
            <x-kpi-card title="{{ __('nav.input_inventory') }}" value="Safe" sub="Monitor min. stock" trend="-0.0%" tone="amber" :icon="$ic('M7 7h10M7 12h10M7 17h10M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z')" />
        </div>

        <div class="mt-5 bakery-card">
            <div class="bakery-card-header">
                <div class="text-lg font-extrabold text-slate-900">{{ __('page.recent_production') }}</div>
            </div>
            <div class="bakery-card-body">
                <div class="grid gap-3">
                    <div class="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3 ring-1 ring-black/5">
                        <div>
                            <div class="text-sm font-extrabold text-slate-800">{{ __('nav.input_production') }}</div>
                    ...
                    <div class="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3 ring-1 ring-black/5">
                        <div>
                            <div class="text-sm font-extrabold text-slate-800">{{ __('nav.input_sales') }}</div>
                            <div class="mt-1 text-xs font-semibold text-slate-400">No data yet</div>
                        </div>
