...
@php
    ...
    $pageSubtitle = 'Neraca saldo per '.FormatHelper::dateId($asOf);
@endphp
    ...
    <div class="bakery-card overflow-hidden">
        <div class="border-b border-slate-100 bg-slate-50 px-4 py-3 sm:px-6">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <p class="text-xs font-bold uppercase tracking-wide text-slate-500">Trial Balance</p>
                    <p class="text-sm font-semibold text-slate-700">Per {{ FormatHelper::dateId($asOf) }}</p>
                    <p class="mt-1 text-xs text-slate-500">Diambil dari semua jurnal (saldo awal, produksi, operasional, restock, jurnal umum).</p>
                </div>
        ...
        <div class="bakery-card-body bakery-table-wrap">
            <table class="bakery-table text-sm">
                <thead>
                    <tr>
                        <th class="w-[72px]">Kode</th>
                        <th class="min-w-[200px]">Akun</th>
                        <th class="w-[44px] text-center">Pos</th>
                        <th class="w-[88px]">Grup</th>
                        <th class="w-[140px]">Sub-Grup</th>
                        <th class="w-[120px] text-right">Debit</th>
                        <th class="w-[120px] text-right">Kredit</th>
                        <th class="w-[120px] text-right">SubTotal</th>
                        <th class="w-[120px] text-right">For FS</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($rows as $row)
