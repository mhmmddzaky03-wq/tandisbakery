...
<nav class="space-y-2">
    ...
    @if ($isKaryawan)
        ...
        <x-nav-link href="{{ route('karyawan.produksi') }}" :active="$active === 'karyawan.produksi'" :icon="$icon('M6 21h12a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-1l-1-2H8L7 7H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2Z')">Data Produksi</x-nav-link>
        <x-nav-link href="{{ route('karyawan.penjualan') }}" :active="$active === 'karyawan.penjualan'" :icon="$icon('M4 7h16M4 11h16M8 15h4M6 19h12')">Transaksi Penjualan</x-nav-link>
    @endif
